...
<div id="order_form" style="<?php if($this->model->inner_price == null){ echo "display:none;"; }?>">
...
.form-block.physical .control-group.physical {
	display:block;
}

.form-block.physical .juridical {
	display:none;
}
