 ...
 * @since  3.3
 */
class CdekRouter extends JComponentRouterBase
{
	/**
	...
	public function parse(&$segments)
	{
		...
		$parcel_number         = array_shift($segments);
		$vars['view']       = 'cdek';
 ...
 */
function cdekBuildRoute(&$query)
{
	$router = new CdekRouter();
 ...
 * @deprecated  4.0  Use Class based routers instead
 */
function cdekParseRoute($segments)
{
	$router = new CdekRouter();
